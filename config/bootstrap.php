...
/**
 * Make some company/application data globally available, making it easy to change later if necessary
 */
Configure::write('App.name', 'StarPort');
Configure::write('JAUNT.phone_number', '(434)296-3184');

Configure::write('PHPUNIT', false);